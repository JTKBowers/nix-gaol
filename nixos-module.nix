...
let
  ...
  pkgOptions = {
    options = {
      pkg = mkOption { type = types.package; description = "The package to wrap"; example = "pkgs.hello"; };
      name = mkOption { type = types.str; description = "The name of the binary to wrap"; };
      extraDepPkgs = mkOption { type = types.listOf types.package; description = "A list of extra packages to make available to the sandbox"; default = [ ]; };
      bindCwd = mkOption { type = types.enum [ true false "ro" ]; description = "Whether to bind the current working directory"; default = false; };
      envs = mkOption { type = types.attrsOf types.str; description = "Environment variables to make available to the sandbox"; default = { }; };
